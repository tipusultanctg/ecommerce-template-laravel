<header>
            ...
            <div class="topbar-content">
                ...
                <div class="content-right">
                    <div class="header-top-menu-item header-lang">
                        <span class="header-lang-toggle" id="header-lang-toggle"><img src="https://shofy-fashion.botble.com/vendor/core/core/base/img/flags/us.svg"
                                                                                      title="English"
                                                                                      loading="lazy" alt="English flag"
                                                                                      class="flag "
                                                                                      data-ll-status="loading"> English
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M6 9l6 6l6 -6"></path></svg></span>
                        <ul class="">
                            <li>
                                <a href="#">
                                    <img
    ...
    <div class="mobile-menu d-sm-none d-block">
        <div class="container">
            <div class="mobile-menu-wrapper">

                <a class="" data-bs-toggle="offcanvas" href="#offcanvas-mobile-menu" role="button" aria-controls="offcanvas-mobile-menu">
                    <span  class="mobile-menu-toggle" href=""><i class="ti ti-align-justified"></i></span>
                </a>
