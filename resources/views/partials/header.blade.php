<header>
            ...
            <div class="topbar-content">
                <div class="content-left">
                    <div class="announcements">
                        <div class="announcement" id="announcement-container">
                            <div class="announcement-navigation">
                                <button id="prev-announcement" class="nav-button">
                                    <i class="ti ti-arrow-left"></i>
                                </button>
                                <button id="next-announcement" class="nav-button">
                                    <i class="ti ti-arrow-right"></i>
                                </button>
                            </div>
                            <div class="announcement-content">
                                <p>This is the content of the first announcement. Stay tuned for more updates!</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="content-right">
                    <div class="header-top-menu-item header-lang">
                        <span class="header-lang-toggle" id="header-lang-toggle">
                            <img src="https://shofy-fashion.botble.com/vendor/core/core/base/img/flags/us.svg"
                                 title="English"
                                 loading="lazy" alt="English flag"
                                 class="flag "
                                 data-ll-status="loading"> English
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path
                                d="M6 9l6 6l6 -6"></path></svg></span>
                        <ul class="">
                            <li>
                                <a href="#">
                                    <img
                                        src="https://shofy-fashion.botble.com/vendor/core/core/base/img/flags/vn.svg"
                                        title="Tiếng Việt" loading="lazy" alt="Tiếng Việt flag"
                                        class="flag page_speed_643949797 entered loading"
                                        data-ll-status="loading"> Spanish</a>
                            </li>
                            <li>
                                <a href="#"><img
                                        src="https://shofy-fashion.botble.com/vendor/core/core/base/img/flags/vn.svg"
                                        title="Tiếng Việt" loading="lazy" alt="Tiếng Việt flag"
                                        class="flag page_speed_643949797 entered loading"
                                        data-ll-status="loading"> Russian</a>
                            </li>
                            <li>
                                <a href="#"><img
                                        src="https://shofy-fashion.botble.com/vendor/core/core/base/img/flags/vn.svg"
                                        title="Tiếng Việt" loading="lazy" alt="Tiếng Việt flag"
                                        class="flag page_speed_643949797 entered loading"
                                        data-ll-status="loading"> Portuguese</a>
                            </li>
                        </ul>
                    </div>

                    <div class="header-top-menu-item header-currency">
                        <span class="header-currency-toggle" id="header-currency-toggle"> Currency
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path
                                d="M6 9l6 6l6 -6"></path></svg></span>
                    ...
                    <div class="header-top-menu-item header-login">
                        <a href="https://shofy-fashion.botble.com/login"><span data-hover="Login"></span></a>
                    </div>
                    <div class="header-top-menu-item header-register">
                        <a href="https://shofy-fashion.botble.com/login"><span data-hover="Register"></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- / contact content -->
    <div class="container">
        <div class="d-flex justify-content-space-between align-items-center my-xl-4 my-md-4 my-sm-2">
            <!-- logo -->
            <a class="logo me-5 d-sm-block d-none">
            ...
            <!-- // search -->
            <nav class="nav-content d-sm-block d-none">
                <!-- nav -->
                <ul class="nav-content-list action-items">
                    <li class="nav-content-item">
                        <a class="header-callus" href="tel:1234">
                            <span class="header-callus-icon"><i aria-hidden="true"
                                                                class="ti ti-brand-whatsapp"></i></span>
                            <span class="header-callus-text">
                        <span class="header-phone-text">Call Anytime</span>
                         <span class="header-phone-number">123 456 7890</span>
                    </span>
                        </a>
                    </li>
                    <li class="nav-content-item">
    ...
    <div class="mobile-menu-container d-sm-none d-block">
        <div class="container">
            <div class="mobile-menu-wrapper">
                <button type="button" class="header-action-btn offcanvas-open-btn">
                    ...
                    <div class="offcanvas__wrapper">
                        ...
                        <div class="offcanvas__content">
                            ...
                            <div class="offcanvas__category pb-40">
                                <button class="offcanvas-category-toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="16" viewBox="0 0 30 16">
                                        <rect x="10" width="20" height="2" fill="currentColor"></rect>
                                        <rect x="5" y="7" width="25" height="2" fill="currentColor"></rect>
                                        <rect x="10" y="14" width="20" height="2" fill="currentColor"></rect>
                            ...
                            <div class="main-menu-mobile fix d-lg-none mb-40">
                                <nav class="main-menu-content">
                                    <ul>
                                        <li class="has-dropdown dropdown-opened"><a href="https://shofy.botble.com/"
                                                                                    title="Home" class=""> Home
                                                <button title="toggle button" class="dropdown-toggle-btn">
                                            ...
                                            <ul class="submenu" style="display: none;">
                                                <li class=""><a href="https://shofy.botble.com" title="Electronics">
                                                        Electronics </a></li>
                                                <li class=""><a href="https://shofy-fashion.botble.com" title="Fashion">
                                                        Fashion </a></li>
                                                <li class=""><a href="https://shofy-beauty.botble.com" title="Beauty">
                                                        Beauty </a></li>
                                                <li class=""><a href="https://shofy-jewelry.botble.com" title="Jewelry">
                                                        Jewelry </a></li>
                                                <li class=""><a href="https://shofy-grocery.botble.com" title="Grocery">
                                                        Grocery </a></li>
                                            </ul>
                                        </li>
                                        <li class="has-dropdown"><a href="https://shofy.botble.com" title="Shop"> Shop
                                                <button title="toggle button" class="dropdown-toggle-btn">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                         stroke="currentColor" stroke-width="2"
                                            ...
                                            <ul class="submenu">
                                                <li class=""><a href="https://shofy.botble.com/categories"
                                                                title="Shop Categories"> Shop Categories </a>
                                                </li>
                                                <li class=""><a href="https://shofy.botble.com/brands"
                                                                title="Shop Brands"> Shop Brands </a></li>
                                                <li class=""><a href="https://shofy.botble.com/products?layout=list"
                                                                title="Shop List"> Shop List </a></li>
                                                <li class=""><a href="https://shofy.botble.com/products?layout=grid"
                                                                title="Shop Grid"> Shop Grid </a></li>
                                                <li class=""><a
                                                        href="https://shofy.botble.com/products/razer-blade-15-advanced-gaming-laptop"
                                                        title="Product Detail"> Product Detail </a></li>
                                                <li class=""><a href="https://shofy.botble.com/coupons"
                                                                title="Grab Coupons"> Grab Coupons </a></li>
                                                <li class=""><a href="https://shofy.botble.com/cart" title="Cart">
                                                        Cart </a></li>
                                                <li class=""><a href="https://shofy.botble.com/compare" title="Compare">
                                                        Compare </a></li>
                                                <li class=""><a href="https://shofy.botble.com/wishlist"
                                                                title="Wishlist"> Wishlist </a></li>
                                                <li class=""><a href="https://shofy.botble.com/orders/tracking"
                                                                title="Track Your Order"> Track Your Order
                                                    </a></li>
                                            </ul>
                                        </li>
                                        <li class=""><a href="https://shofy.botble.com/stores" title="Vendors">
                                                Vendors </a></li>
                                        <li class="has-dropdown"><a href="https://shofy.botble.com" title="Pages"> Pages
                                                <button title="toggle button" class="dropdown-toggle-btn">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                         stroke="currentColor" stroke-width="2"
                                            ...
                                            <ul class="submenu">
                                                <li class=""><a href="https://shofy.botble.com/faqs" title="FAQs">
                                                        FAQs </a></li>
                                                <li class=""><a href="https://shofy.botble.com/login" title="Login">
                                                        Login </a></li>
                                                <li class=""><a href="https://shofy.botble.com/register"
                                                                title="Register"> Register </a></li>
                                                <li class=""><a href="https://shofy.botble.com/password/reset"
                                                                title="Forgot Password"> Forgot Password </a>
                                                </li>
                                                <li class=""><a href="https://shofy.botble.com/404" title="404 Error">
                                                        404 Error </a></li>
                                                <li class=""><a href="https://shofy.botble.com/coming-soon"
                                                                title="Coming Soon"> Coming Soon </a></li>
                                            </ul>
                                        </li>
                                        <li class="has-dropdown"><a href="https://shofy.botble.com/blog" title="Blog">
                                                Blog
                                                <button title="toggle button" class="dropdown-toggle-btn">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <ul class="submenu">
                                                <li class=""><a href="https://shofy.botble.com/blog?layout=grid"
                                                                title="Blog Grid"> Blog Grid </a></li>
                                                <li class=""><a href="https://shofy.botble.com/blog?layout=list"
                                                                title="Blog List"> Blog List </a></li>
                                                <li class=""><a
                                                        href="https://shofy.botble.com/blog/9-things-i-love-about-shaving-my-head"
                                                        title="Blog Detail"> Blog Detail </a></li>
                                            </ul>
                                        </li>
                                        <li class=""><a href="https://shofy.botble.com/contact" title="Contact">
                                                Contact </a></li>
                                    </ul>
                                </nav>
                            </div>
    ...
    <div class="menu-bar d-sm-block d-none">
        <div class="container">
            <div class="nav-container">
                <div class="header-category category-menu header-category-toggle">
                    <button class="category-menu-btn category-menu-toggle">
                                 <span>
                    ...
                    <label class="open-menu-all" for="open-menu-all">
                        ...
                        <ul class="all-category-list">
                            <li class="all-category-list-item"><a href="#"
                                                                  class="all-category-list-link">Smartphones<i
                                        class="fas fa-angle-right"></i></a>
                                <div class="category-second-list">
                                    <ul class="category-second-list-ul">
                                        <li class="category-second-item"><a href="#">Iphone 10</a></li>
                                        <li class="category-second-item"><a href="#">Galaxy Note 10</a>
                                        </li>
                                        <li class="category-second-item"><a href="#">Motorola One </a>
                                        </li>
                                        <li class="category-second-item"><a href="#">Galaxy A80 </a>
                                        </li>
                                        <li class="category-second-item"><a href="#">Galaxy M </a></li>
                                        <li class="category-second-item"><a href="#">Huaway P30 </a>
                                        </li>
                                    </ul>
                            ...
                            <li class="all-category-list-item"><a href="#"
                                                                  class="all-category-list-link">Furniture <i
                                        class="fas fa-angle-right"></i></a></li>
                            <li class="all-category-list-item"><a href="#"
                                                                  class="all-category-list-link">Toys<i
                                        class="fas fa-angle-right"></i></a></li>
                            <li class="all-category-list-item"><a href="#"
                                                                  class="all-category-list-link">Computing<i
                                        class="fas fa-angle-right"></i></a></li>
                            <li class="all-category-list-item"><a href="#"
                                                                  class="all-category-list-link">Games<i
                                        class="fas fa-angle-right"></i></a></li>
                ...
                <nav class="featured-category">
                    <ul class="nav-row ms-3">
                        <li class="nav-row-list"><a href="#" class="nav-row-list-link">
                                <i class="ti ti-home me-1"></i> <span data-hover="Home"></span>
                            </a>
                        </li>
                        <li class="nav-row-list"><a href="#" class="nav-row-list-link"> <i
                                    class="ti ti-shopping-bag me-1"></i> <span data-hover="Shop"></span></a>
                        </li>
                        <li class="nav-row-list"><a href="#" class="nav-row-list-link"><i
                                    class="ti ti-speakerphone me-1"></i> <span data-hover="Features"></span></a></li>
                        <li class="nav-row-list"><a href="#" class="nav-row-list-link"><i
                                    class="ti ti-gift-card me-1"></i> <span data-hover="Gift Cards"></span></a>
                        </li>
                        </li>
                    </ul>
                </nav>
                <ul class="nav-list">
                    <li class="nav-row-list"><a
                            href="" class="text-light"><span data-hover="Flash Deals"></span></a></li>
                    <li class="nav-row-list"><a class="text-light"
                                                href=""><span data-hover="New Arrivals"></span></a>
                    </li>
                    <li class="nav-row-list"><a class="text-light"
                                                href=""><span data-hover="Super Sale!"></span></a></li>
                    <li class="nav-row-list"><a class="text-light"
                                                href=""><span data-hover="Outlet"></span></a>
                    </li>
                </ul>
            </div>
        </div>
